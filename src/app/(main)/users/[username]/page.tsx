...
export default async function Page({params}: PageProps){
    ...
    return (<main className="flex w-full min-w-0 gap-5">
        <div className="w-full min-w-0 space-y-5">
            ...
            {/* 美化的帖子分隔条 */}
            <div className="relative rounded-2xl bg-card p-5 shadow-sm overflow-hidden">
              ...
              <h2 className="text-center text-lg font-semibold text-muted-foreground tracking-wide">
          ...
          <div className="flex flex-wrap gap-3 sm:flex-nowrap">
            <div className="me-auto space-y-4">
              ...
              <div>
                ...
                <div className="mt-0.5 text-muted-foreground">@{user.username}</div>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm text-muted-foreground">
                <div className="flex items-center gap-2">
                  ...
                  <span>
                    🚀 {formatDate(user.createAt, "yyyy年M月d日")} 敲下了在 CodeHub 的第一行代码
                  </span>
                </div>
              </div>
            ...
            {user.id === loggedInUserId ? (
              <Button className="transition-all duration-300 hover:-translate-y-0.5 hover:shadow-md">
                修改个人资料
              </Button>
            ) : (
          ...
          {user.bio && (
            <>
              ...
              <div className="relative rounded-lg bg-muted/30 px-5 py-4">
                <span className="absolute -top-3 left-3 text-4xl font-serif leading-none text-primary/20">
                  &ldquo;
                </span>
                <div className="whitespace-pre-line overflow-hidden break-words text-sm leading-relaxed">
                  {user.bio}
                </div>
                <span className="absolute -bottom-5 right-3 text-4xl font-serif leading-none text-primary/20">
                  &rdquo;
                </span>
              </div>
            </>
