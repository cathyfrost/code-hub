...
export default function QuizDetail({ quizId }: Props) {
  ...
  if (error || !quiz) {
    return (
      <div className="flex h-[calc(100vh-6rem)] flex-col items-center justify-center gap-3">
        <p className="text-destructive">{error || "题目不存在"}</p>
  ...
  const examples = quiz.examples as QuizExample[];
